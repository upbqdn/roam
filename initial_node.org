...
As per [[.theorem-1][Theorem 1]] [cite:@iva].
...
#+begin_src rust -n
fn main() -> Foo {
    println!("ffoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoofoooo");
}
#+end_src
#+begin_center

...
#+BEGIN_df
<<.def-m>> *[[.def-m][Definition m]]*. Let \(R\) be a commutative [[id:ring][ring]] and \(\emptyset \ne I \subseteq R\). Then
...
#+BEGIN_rem
<<.rem-c>> *[[.rem-c][Remark c]]*. [[.def-m][Definition m]] says that if \(R\) is a commutative [[id:ring][ring]],
...
#+BEGIN_pr
<<.prp-p>> *[[.prp-p][Proposition p]]*. Let \(I\) be an [[.def-m][ideal]] of a commutative [[id:ring][ring]] \(R\).
Then:

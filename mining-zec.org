...
#+title: Mining Zcash
#+date: [2024-01-13 Sat]
#+hugo_lastmod: [2026-09-23 Wed 16:07]
...
# Keep the opening video tag on its own line so Hugo preserves the subtitle track.
#+begin_export html
<video controls>
...
but haven't had the time to do anything meaningful yet. So no persistent SSH
access yet.
...
via the relays. Below is the backend. The insulated garden hoses from the
...
By the way, the new mining setup reduces CO2 emissions. Unlike
...
consumed 32 MWh. The solar system directly offset 1/3 of that and pushed three
...
The remaining 21 MWh were sourced like this. The house doesn't use any other
heating.
